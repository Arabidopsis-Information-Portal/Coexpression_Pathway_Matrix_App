(function(window, $, undefined) {
    ...
    console.log('Welcome to the Co-expression Matrix App!');
	...
	var default_gene_json = 
		...
		, {"traceback": "Traceback (most recent call last):\n  File \"/root/worker.py\", line 44, in callback\n    adama = self.operation(message, responder=responder)\n  File \"/root/worker.py\", line 73, in operation\n    fun(d)\n  File \"/root/user_code/main.py\", line 60, in search\n    agi_locus_from_entrez = resolve_locus(result['gene'])\n  File \"/root/user_code/main.py\", line 89, in resolve_locus\n    result = response.json()['results'][0]['data'][0]['row'][0]\nIndexError: list index out of range\n", "error": "list index out of range"}
	    ],
